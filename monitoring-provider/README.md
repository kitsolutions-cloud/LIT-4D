...
A full observability stack using **Loki** for log aggregation, **Grafana Alloy** for log shipping, and **Grafana** for
visualization.
...
- **Loki:** Log aggregation system.
    - Data: `./loki/.data`
- **Alloy:** Scrapes logs from `/var/log/` (mapped to `./alloy/app-logs/`) and pushes to Loki.
...
> [!WARNING]
> **GrowthBook** and **Grafana Stack** share the same default ports (3000/3100). If you need to run both simultaneously,
> you must change the port mappings in `compose.override.yml`.

...
**Keycloak** is an open-source identity and access management solution. This project includes a pre-configured realm and integration with SNS/SQS for event-driven architectures.
...
> [!TIP]
> Custom configs can be added to `./helms/my-app.realm.json`. You can also [import/export realms](https://www.keycloak.org/server/importExport#_importing_a_realm_from_a_file) as needed.

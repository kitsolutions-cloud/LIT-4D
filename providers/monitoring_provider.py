...
class _MonitoringProviderAlloyFunctions(common.CommonProviderFunctions):
    ...
    PROVIDER_DIR = settings.MAIN_DIR / 'monitoring-provider/alloy'
    PROVIDER_IMAGE_VERSION_LABEL = "MONITORING_PROVIDER_ALLOY_IMAGE_VERSION"


class _MonitoringProviderGrafanaFunctions(common.CommonProviderFunctions):
    """The available functions to alloy service."""
    PROVIDER_DIR = settings.MAIN_DIR / 'monitoring-provider/grafana'
    PROVIDER_IMAGE_VERSION_LABEL = "MONITORING_PROVIDER_GRAFANA_IMAGE_VERSION"


class _MonitoringProviderLokiFunctions(common.CommonProviderFunctions):
    """The available functions to alloy service."""
    PROVIDER_DIR = settings.MAIN_DIR / 'monitoring-provider/loki'
    PROVIDER_IMAGE_VERSION_LABEL = "MONITORING_PROVIDER_LOKI_IMAGE_VERSION"
